...
export const Projects = () => {
  const Projects = [
...

    {
      ...
      description4:
        "Front-end application | React, React-bootstrap & Animate.css",
      imgUrl4: projImg4,
    },
    {
      title4: "Personal Portfolio Website",
            ...
            <Tab.Container id="projects-tabs" defaultActiveKey="first">
              ...
              <Tab.Content>
                <Tab.Pane eventKey="first">
                  <a
                    href="https://github.com/ChamilSachintha/Pharmacy-Management-System"
                    target="_blank"
                  >
                    <Row>
                ...
                <Tab.Pane eventKey="second">
                  <a
                    href="https://github.com/ChamilSachintha/personal-portfolio"
                    target="_blank"
                  >
                    <Row>
                      {Projects.map((project, index) => {
                  ...
                  <a
                    href="https://github.com/ChamilSachintha/Student-Progress-Viewer"
                    target="_blank"
                  >
                    <Row>
                      {Projects.map((project, index) => {
                        return <ProjectCard6 key={index} {...project} />;
                      })}
                    </Row>
                  </a>
                </Tab.Pane>
                <Tab.Pane eventKey="third">
                  <a
                    href="https://www.figma.com/file/08BeH4Xv1yw2M819bzyFzS/Design-1?t=jZK3aOJNwAHjyEXN-1"
                    target="_blank"
                  >
                    <Row>
                      {Projects.map((project, index) => {
                  ...
                  <a
                    href="https://www.figma.com/file/z43S0OGbQfysKm7UnrVPN7/Untitled?node-id=0%3A1&t=hZ2sHzDIn2XEXvpB-1"
                    target="_blank"
                  >
                    <Row>
                      {Projects.map((project, index) => {
                        return <ProjectCard5 key={index} {...project} />;
                      })}
                    </Row>
                  </a>
                  <a
                    href="https://www.figma.com/file/IPv7RZ6prAhNObLnDxr76Z/UI%2FUX-Design-for-Academic-Calendar?node-id=0%3A1&t=jZK3aOJNwAHjyEXN-1"
                    target="_blank"
                  >
                    <Row>
                      {Projects.map((project, index) => {
